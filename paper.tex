...
\newcommand\isenv[2]{\ensuremath{\InputMode{#1}\in^\star\InputMode{#2}}}
\newcommand\eqenv[3]{\ensuremath{\InputMode{#1}=\InputMode{#2}\in^\star\InputMode{#3}}}
